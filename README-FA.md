...
ابزاری ساده و کاربردی برای تشخیص User-Agent های معتبر و فیلتر کردن User-Agentهای خراب یا غیرفعال. ایده‌آل برای توسعه‌دهندگان، اسکریپت‌نویس‌ها و خزنده‌هایی که نیاز دارند به سرعت وضعیت User-Agentها را آزمایش کنند. با یک نگاه، ببینید کدام User-Agentها قابل استفاده هستند و کدام‌ها نیستند.
<div align="center">
    <p>
        <a href="README.md">
